...
public class SpotlightAnnotator extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		...
		// TODO: Reduce memory?
		conf.set(JobContext.MAP_MEMORY_MB, 1000);
		conf.set(JobConf.MAPRED_CHILD_JAVA_OPTS, "-Xmx800m");
		conf.set(JobContext.MAP_JAVA_OPTS, "-Xmx800m -XX:+UseParallelOldGC -XX:ParallelGCThreads=4");
		conf.set(JobContext.TASK_TIMEOUT, 600000);
		conf.set(JobContext.MAP_MAX_ATTEMPTS, 1);
